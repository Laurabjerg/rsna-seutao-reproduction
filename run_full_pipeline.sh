...
python3 prepare_data.py -dcm_path "${RSNA_STAGE1_TRAIN_DIR}" -png_path "${SEUTAO_REPO_DIR}/2DNet/train_png"
python3 prepare_data.py -dcm_path "${RSNA_STAGE1_TEST_DIR}" -png_path "${SEUTAO_REPO_DIR}/2DNet/train_png"
python3 prepare_data.py -dcm_path "${RSNA_STAGE2_TEST_DIR}" -png_path "${SEUTAO_REPO_DIR}/2DNet/test_png"
...
echo "Forventet output: ${SEUTAO_REPO_DIR}/FinalSubmission/version3_debug/"